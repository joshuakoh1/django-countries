...
def check_currency():
    currency_missing = set(COUNTRIES) - set(CURRENCY)
    if currency_missing:  # pragma: no cover
        print("")
        print("The following countries do not match with currency list:")
        for code, description in sorted(currency_missing):
